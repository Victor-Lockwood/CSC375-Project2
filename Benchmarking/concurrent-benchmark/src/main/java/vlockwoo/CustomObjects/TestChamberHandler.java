...
public class TestChamberHandler {
    ...
    public TestChamberHandler(int suggestedNumberOfWorkers, int percentReads, int maxChambers) {
    ...
    public synchronized TestChamber generateRandomTestChamber(boolean isInitial) {
        ...
        if(!isInitial) {
            while(findIdInList(idCandidate)) {
                idCandidate = ThreadLocalRandom.current().nextInt(Integer.MAX_VALUE);
            }
        }
